...
var logoUtils_1 = require("@/app/lib/server/logoUtils");
var fs_1 = require("fs");
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var cookieStore, tokenCookie, formData, file, businessId, validTypes, maxSize, uploadDir, filename, filePath, arrayBuffer, buffer, logoUrl, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!businessId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "No se ha proporcionado el ID del negocio." }, { status: 400 })];
                    }
                    ...
                    if (file.size > maxSize) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "El logo no debe superar los 2MB." }, { status: 400 })];
                    }
                    uploadDir = logoUtils_1.ensureLogoDirectory();
                    filename = logoUtils_1.generateLogoFilename(businessId, file.name);
